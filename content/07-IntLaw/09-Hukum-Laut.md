...
```mermaid
graph TD
    A["Garis Pangkal"] -->|0-12 nm| B["Laut Territorial<br/>Kedaulatan Penuh"]
    A -->|0-24 nm| C["Zona Tambahan<br/>Kontrol Terbatas"]
    A -->|0-200 nm| D["Zona Ekonomi Eksklusif<br/>Hak Ekonomi Eksklusif"]
    A -->|hingga 350 nm| E["Landas Kontinen<br/>Hak Eksplorasi Non-Hayati"]
    D -->|Beyond 200 nm| F["Laut Lepas<br/>Mare Liberum"]
    D -->|Dasar Laut Dalam| G["Area<br/>Common Heritage"]
```
...
```mermaid
graph TD
    A["Kapal Asing"] -->|Laut Territorial| B["Innocent Passage<br/>Art 17-26<br/>Cepat, Kontinyu<br/>Tidak Mengganggu"]
    A -->|Selat Internasional| C["Transit Passage<br/>Art 37-44<br/>Menghormati Peraturan<br/>Navigasi"]
    A -->|Perairan Kepulauan| D["Archipelagic Sea Lanes<br/>Art 53-54<br/>Melalui Alur Laut<br/>yang Ditetapkan"]
    A -->|Laut Lepas| E["Kebebasan Berlayar<br/>Art 87<br/>Non-Diskriminatif"]
```
