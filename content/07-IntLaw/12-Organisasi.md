...
```mermaid
graph TD
    A[Organisasi Internasional] --> B[Berdasarkan Anggota]
    A --> C[Berdasarkan Scope Geografis]
    A --> D[Berdasarkan Fungsi]
    A --> E[Berdasarkan Struktur Kelembagaan]
    
    B --> B1[Universal<br/>PBB, WTO, WHO]
    B --> B2[Regional<br/>ASEAN, AU, OAS]
    B --> B3[Selective<br/>NATO, G7, OECD]
    
    C --> C1[Global]
    C --> C2[Regional]
    C --> C3[Subregional]
    
    D --> D1[Politik & Keamanan<br/>PBB, NATO]
    D --> D2[Ekonomi<br/>WTO, IMF, World Bank]
    D --> D3[Sosial & Kemanusiaan<br/>WHO, UNESCO, ILO]
    D --> D4[Teknis & Khusus<br/>ITU, IMO, ICAO]
    
    E --> E1[General Purpose<br/>Banyak fungsi]
    E --> E2[Specialized<br/>Fungsi terbatas]
```
...
```mermaid
timeline
    title Perkembangan Organisasi Internasional Utama
    1815 : Concert of Europe : Rhine Commission
    1865 : International Telegraph Union (ITU)
    1874 : Universal Postal Union (UPU)
    1899 : Konferensi La Haya Pertama
    1907 : Konferensi La Haya Kedua : Permanent Court of Arbitration
    1919 : Liga Bangsa-Bangsa (LBB)
    1945 : Perserikatan Bangsa-Bangsa (PBB) : Piagam San Francisco
    1947 : GATT (General Agreement on Tariffs and Trade)
    1967 : ASEAN : Bangkok Declaration
...
```mermaid
graph TD
    A[PERSERIKATAN BANGSA-BANGSA] --> B[Majelis Umum<br/>General Assembly<br/>193 Anggota]
    A --> C[Dewan Keamanan<br/>Security Council<br/>15 Anggota]
    A --> D[Dewan Ekonomi & Sosial<br/>ECOSOC<br/>54 Anggota]
    A --> E[Komite Perwalian<br/>Trusteeship Council<br/>5 Anggota]
    A --> F[Mahkamah Internasional<br/>International Court of Justice<br/>15 Hakim]
    A --> G[Sekretariat<br/>Secretariat<br/>Sekjen & Staff]
    
    B --> B1[Komite Utama<br/>Main Committees]
    B --> B2[Komite Khusus<br/>Special Committees]
    B --> B3[Program & Dana<br/>Programs & Funds]
    
    C --> C1[Anggota Tetap<br/>USA, UK, Perancis<br/>Rusia, Tiongkok]
    C --> C2[Anggota Tidak Tetap<br/>10 Negara<br/>2 tahun]
    
    D --> D1[Komisi Fungsional]
    D --> D2[Komisi Regional]
    D --> D3[Badan Koordinasi]
```
