...
```mermaid
graph TD
    A["Kriteria Statehood<br/>Konvensi Montevideo 1933"] --> B["Populasi Tetap<br/>(Permanent Population)"]
    A --> C["Wilayah Terdefinisi<br/>(Defined Territory)"]
    A --> D["Pemerintahan<br/>(Government)"]
    A --> E["Kapasitas Hubungan<br/>Internasional<br/>(Capacity for Relations)"]
    
    B --> B1["Kewarganegaraan jelas"]
    B --> B2["Komunitas stabil"]
    B --> B3["Contoh Masalah:<br/>Palestina, diaspora"]
    
    C --> C1["Batas geografis terang"]
    C --> C2["Tidak ada ambang ukuran"]
    C --> C3["Contoh Masalah:<br/>Siprus terbagi, Kosovo"]
    
    D --> D1["Otoritas pusat efektif"]
    D --> D2["Tidak harus demokratis"]
    D --> D3["Contoh Masalah:<br/>Negara gagal"]
    
    E --> E1["Membuat perjanjian"]
    E --> E2["Perwakilan diplomatik"]
    E --> E3["Partisipasi internasional"]
```
...
```mermaid
graph TD
    A["Organisasi Internasional"] --> B["Legal Personality"]
    A --> C["Hak"]
    A --> D["Kewajiban"]
    A --> E["Tanggung Jawab"]
    
    B --> B1["Ekspres:<br/>Dinyatakan dalam Charter"]
    B --> B2["Implisit:<br/>Diakui melalui praktik<br/>& yurisprudensi"]
    
    C --> C1["Membuat perjanjian"]
    C --> C2["Memiliki properti"]
    C --> C3["Mempekerjakan staf"]
    C --> C4["Mengajukan klaim"]
    
    D --> D1["Mematuhi hukum<br/>internasional"]
    D --> D2["Menghormati<br/>kedaulatan"]
    D --> D3["Beroperasi sesuai<br/>charter"]
    
    E --> E1["Atas tindakan organ"]
    E --> E2["Atas instruksi<br/>kepada anggota"]
    E --> E3["Atas kegagalan<br/>oversight"]
```
...
```mermaid
timeline
    title Evolusi Individu sebagai Subjek Hukum Internasional
    1945 : Nuremberg Trials
    1945 : Pengakuan tanggung jawab pidana individu
    1946 : Tokyo Tribunal
    1948 : Deklarasi Universal Hak Asasi Manusia
    1950 : Konvensi Eropa Hak Asasi Manusia
    1966 : Perjanjian Hak Sipil dan Politik Internasional
    1966 : ICSID
    1993 : ICTY
    1994 : ICTR
    1998 : Rome Statute
    2002 : Pengadilan Pidana Internasional mulai beroperasi
    2000s : Perkembangan responsibility to protect
```
...
```mermaid
flowchart TD
    A["Hak Penentuan Nasib Sendiri"] --> B["Internal<br/>Self-Determination"]
    A --> C["External<br/>Self-Determination"]
    
    B --> B1["Hak berdemokrasi"]
    B --> B2["Hak partisipasi"]
    B --> B3["Hak hak asasi manusia"]
    
    C --> C1["Konteks Colonial"]
    C --> C2["Konteks Post-Colonial"]
    
    C1 --> C1a["Dekolonisasi"]
    C1 --> C1b["Uti Possidetis Juris"]
    
    C2 --> C2a["Remedial Secession"]
    C2 --> C2b["Status Quo"]
    
    C2a --> D["Studi Kasus:<br/>Kosovo, Palestina,<br/>Timor Leste"]
    C2b --> E["Studi Kasus:<br/>Catalonia, Scotland,<br/>Quebec"]
```
