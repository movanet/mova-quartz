...
> Rekaman pendek yang meringkas materi bab ini, tiga sampai lima menit per bagian: [[06-PerubahanIklim/Kuliah-Audio#Pertemuan 11 — Studi Perbandingan Hukum Iklim Antaryurisdiksi|Dengarkan Pertemuan 11 — Studi Perbandingan Hukum Iklim Antaryurisdiksi]].
...
```mermaid
graph LR
    A[BAB 7: Hukum Indonesia] --> B[BAB 9: Perbandingan]
    C[BAB 8: NEK] --> B
    B --> D[BAB 10: Sektoral]
...
[^16]: Falkner R, 'The [Paris Agreement](https://unfccc.int/process-and-meetings/the-paris-agreement) and the new logic of international climate politics' (2016) 92 International Affairs 1107, 1115-1120.
...
[^29]: Setzer J dan Higham C, *Global Trends in Climate Change Litigation: 2023 Snapshot* ([Grantham Research Institute](https://www.lse.ac.uk/granthaminstitute/), LSE 2023) 5-10.
...
```mermaid
graph TB
    A[Model Hukum Iklim] --> B[Regulasi/EU]
    A --> C[Insentif/AS]
    A --> D[Administratif/China]
    B --> E[Target Mengikat]
    B --> F[ETS Harga Tinggi]
    C --> G[Tax Credits]
    C --> H[Litigasi]
    D --> I[Planning]
    D --> J[ETS Harga Rendah]
    E --> K[Indonesia: Kombinasi?]
    F --> K
    G --> K
    H --> K
    I --> K
...
- → [[Buku-Ajar-Hukum-06-PerubahanIklim-10-Hukum-Iklim-Sektoral_BAB-10|BAB 10: Hukum Iklim Sektoral]]
