...
```mermaid
graph LR
    A[BAB 7: Hukum Indonesia] --> B[BAB 10: Sektoral]
    C[BAB 8: NEK] --> B
    D[BAB 9: Perbandingan] --> B
    B --> E[BAB 14: Adaptasi Sektoral]
```

Bab ini memperdalam [[07-Kerangka-Hukum-Indonesia/BAB-07|BAB 7]] dengan fokus pada regulasi sektor-sektor utama. Untuk pembahasan adaptasi sektoral (bukan mitigasi), lihat [[14-Hukum-Adaptasi-Sektoral/BAB-14|BAB 14]].

### 5. Peta Konsep Bab

```mermaid
mindmap
  root((BAB 10: Sektoral))
    Energi
      Transisi EBT
...
```mermaid
graph TB
    A[NDC Indonesia] --> B[Sektor Energi]
    A --> C[Sektor FOLU]
    A --> D[Sektor Transportasi]
    A --> E[Sektor Industri]
    B --> B1[Perpres 112/2022]
    B --> B2[PP 40/2025]
    C --> C1[REDD+]
    C --> C2[FOLU Net Sink]
    D --> D1[Perpres 55/2019]
    D --> D2[Transit Massal]
    E --> E1[PP 70/2009]
    E --> E2[CCUS]
```
...
|--------------------|----------|---------------|
| **90 - 100%** | Baik Sekali | Selamat! Anda dapat melanjutkan ke [[11-Litigasi-Perubahan-Iklim/BAB-11\|BAB 11]] |
...
- → [[11-Litigasi-Perubahan-Iklim/BAB-11|BAB 11: Litigasi Perubahan Iklim]]
