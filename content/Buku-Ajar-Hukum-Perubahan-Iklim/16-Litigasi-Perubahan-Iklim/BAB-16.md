...
```mermaid
graph LR
    A[BAB 15: Loss & Damage] --> B[BAB 16: Litigasi Iklim]
    C[BAB 3: Arsitektur Rezim] --> B
    D[BAB 11: Litigasi] --> B
    B --> E[Seluruh BAB]
```

Bab ini memperdalam dan memperbarui pembahasan litigasi di [[11-Litigasi-Perubahan-Iklim/BAB-11|BAB 11]] dengan perkembangan terbaru termasuk ICJ Advisory Opinion 2025. Pemahaman tentang litigasi iklim juga terhubung dengan [[15-Loss-and-Damage/BAB-15|BAB 15]] (kompensasi *loss and damage* melalui pengadilan) dan [[03-Arsitektur-Rezim-Iklim/BAB-03|BAB 3]] (interpretasi kewajiban dalam traktat iklim).

### 5. Peta Konsep Bab

```mermaid
mindmap
  root((BAB 16: Litigasi Iklim))
    Perkembangan Global
      Tren 2015-2025
      3000+ kasus
