...
```mermaid
graph LR
    A[BAB 3: Arsitektur Rezim] --> B[BAB 8: NEK]
    C[BAB 6: Pendanaan] --> B
    B --> D[BAB 7: Hukum Indonesia]
    B --> E[BAB 9: Perbandingan]
    B --> F[BAB 10: Sektoral]
```

Bab ini terkait erat dengan [[06-Pendanaan-Mekanisme-Iklim/BAB-06|BAB 6 tentang Pendanaan]] karena pasar karbon merupakan salah satu instrumen pendanaan iklim, dan [[07-Kerangka-Hukum-Indonesia/BAB-07|BAB 7 tentang Kerangka Hukum Indonesia]] yang membahas regulasi iklim nasional secara umum.

### 5. Peta Konsep Bab

```mermaid
mindmap
  root((BAB 8: Pasar Karbon))
    Konsep NEK
      Eksternalitas
      Internalisasi
      Pricing Carbon
...
```mermaid
graph TB
    A[Emisi GRK] --> B{Instrumen NEK}
    B --> C[Cap & Trade]
    B --> D[Baseline & Credit]
    B --> E[Pajak Karbon]
    C --> F[SPE di Bursa]
    D --> G[Offset Karbon]
    E --> H[Pungutan Pemerintah]
    F --> I[Pengurangan Emisi]
    G --> I
    H --> I
```
...
|--------------------|----------|---------------|
| **90 - 100%** | Baik Sekali | Selamat! Anda dapat melanjutkan ke [[09-Perbandingan-Hukum-Iklim/BAB-09\|BAB 9]] |
...
- → [[09-Perbandingan-Hukum-Iklim/BAB-09|BAB 9: Studi Perbandingan Hukum Iklim]]
