...
tags:
  ...
  - inventarisasi
date: 2026-04-09
topik: "Perencanaan Lingkungan Hidup"
pertemuan: 3
publish: true
---
...
```mermaid
graph LR
    A[Inventarisasi LH<br/>Pasal 6] --> B[Penetapan<br/>Ekoregion<br/>Pasal 7]
    B --> C[Penyusunan<br/>RPPLH<br/>Pasal 9-11]
    C --> D[KLHS<br/>Pasal 14-18]
    D --> E[Integrasi<br/>Tata Ruang]
...
```mermaid
graph TD
    subgraph "Batas Administratif"
        KAB1[Kabupaten A]
        KAB2[Kabupaten B]
        KAB3[Kabupaten C]
    end
    
    subgraph "Batas Ekoregion"
        EKO1[Ekoregion DAS Citarum]
    end
    ...
    EKO1 --> DD[Penetapan Daya Dukung<br/>dan Daya Tampung]
    DD --> RPPLH[Penyusunan RPPLH]
    
    style EKO1 fill:#bbdefb
    style DD fill:#c8e6c9
    style RPPLH fill:#a5d6a7
```
...
```mermaid
graph TD
    A["RPPLH NASIONAL<br/>(Menteri LHK)"] --> B["RPPLH PROVINSI<br/>(Gubernur)"]
    B --> C["RPPLH KABUPATEN/KOTA<br/>(Bupati/Walikota)"]
    
    A -->|"menjadi dasar<br/>penyusunan"| B
    B -->|"menjadi dasar<br/>penyusunan"| C
    
    D["Inventarisasi LH<br/>Nasional"] --> A
    E["Inventarisasi LH<br/>Pulau/Kepulauan"] --> B
    F["Inventarisasi LH<br/>Ekoregion"] --> C
...
```mermaid
graph TD
    RPPLH["RPPLH<br/>(30 tahun)"] --> RPJPD["RPJPD<br/>(20 tahun)"]
    RPPLH --> RTRW["RTRW<br/>(20 tahun)"]
    RPJPD --> RPJMD["RPJMD<br/>(5 tahun)"]
    RPJMD --> RKPD["RKPD<br/>(1 tahun)"]
    RTRW --> RDTR["RDTR"]
    
    KLHS1["KLHS"] -.->|evaluasi| RTRW
    KLHS2["KLHS"] -.->|evaluasi| RPJMD
    
    style RPPLH fill:#4caf50,color:#fff
    style KLHS1 fill:#ff9800,color:#fff
    style KLHS2 fill:#ff9800,color:#fff
```
...
```mermaid
graph TD
    A["1. PENGKAJIAN<br/>Analisis pengaruh KRP<br/>terhadap kondisi LH"] --> B["2. PERUMUSAN ALTERNATIF<br/>Penyempurnaan KRP<br/>berdasarkan hasil kajian"]
    B --> C["3. REKOMENDASI<br/>Perbaikan untuk<br/>pengambilan keputusan"]
    C --> D{"Daya dukung &<br/>daya tampung<br/>terlampaui?"}
    D -->|Ya| E["KRP WAJIB DIPERBAIKI<br/>Pasal 17 ayat 2 huruf a"]
    D -->|Tidak| F["KRP dapat<br/>dilanjutkan"]
    E --> G["Moratorium usaha/kegiatan<br/>yang melampaui DD/DT<br/>Pasal 17 ayat 2 huruf b"]
...
```mermaid
graph TD
    INV["Inventarisasi LH<br/>(Pasal 6 UU 32/2009)"] --> EKO["Penetapan<br/>Ekoregion<br/>(Pasal 7)"]
    EKO --> RPPLH["RPPLH<br/>(Pasal 9-11)"]
    RPPLH --> KLHS["KLHS<br/>(Pasal 15-18)"]
    
    KLHS --> RTRW["RTRW/RDTR<br/>(UU 26/2007)"]
    KLHS --> RPJP["RPJP/RPJM"]
    
    RTRW --> AMDAL["AMDAL<br/>(Pasal 22-33)"]
    RPJP --> PROG["Program<br/>Pembangunan"]
    
    AMDAL --> IZIN["Izin<br/>Lingkungan"]
    
    style KLHS fill:#ff9800,color:#fff
    style RTRW fill:#2196f3,color:#fff
    style RPPLH fill:#4caf50,color:#fff
```
...
```mermaid
graph TD
    A["Hasil Kajian:<br/>Daya Tampung TERLAMPAUI"] --> B["MORATORIUM IZIN BARU<br/>Tidak ada izin lingkungan baru<br/>Perluasan menambah beban tidak diizinkan"]
    B --> C["KEWAJIBAN PENGURANGAN BEBAN<br/>Usaha eksisting wajib menurunkan<br/>beban pencemar<br/>Peningkatan teknologi IPAL/pengendalian emisi"]
    C --> D["PENETAPAN BAKU MUTU LEBIH KETAT<br/>Pemerintah daerah menetapkan<br/>baku mutu lokal lebih ketat<br/>dari baku mutu nasional"]
    D --> E["PEMULIHAN DAYA DUKUNG<br/>Program pemulihan lingkungan<br/>Restorasi ekosistem<br/>Rehabilitasi DAS"]
