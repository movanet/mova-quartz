...
```mermaid
graph TD
    A[KEADILAN LINGKUNGAN] --> B[Keadilan Distributif]
    A --> C[Keadilan Prosedural]
    A --> D[Keadilan Pengakuan]
    B --> B1[Distribusi beban dan manfaat lingkungan secara adil]
    B --> B2[Tidak ada komunitas yang menanggung beban tidak proporsional]
    B --> B3[Akses setara terhadap sumber daya alam dan lingkungan bersih]
    C --> C1[Partisipasi bermakna dalam pengambilan keputusan]
    C --> C2[Akses informasi lingkungan]
    C --> C3[Akses keadilan melalui pengadilan]
    D --> D1[Pengakuan identitas dan budaya komunitas]
    D --> D2[Penghormatan terhadap pengetahuan dan kearifan lokal]
    D --> D3[Penghapusan diskriminasi dan stigmatisasi]
```
...
```mermaid
graph TD
    A[HAK PROSEDURAL LINGKUNGAN] --> B[Pilar I: Akses Informasi]
    A --> C[Pilar II: Akses Partisipasi]
    A --> D[Pilar III: Akses Keadilan]
    B --> B1["Pasal 65 ayat (3) UU 32/2009"]
    B --> B2[Hak mendapat informasi lingkungan dari pemerintah]
    B --> B3[Transparansi data kualitas lingkungan]
    C --> C1["Pasal 65 ayat (4)-(5) UU 32/2009"]
    C --> C2[Partisipasi dalam AMDAL]
    C --> C3[Keterlibatan dalam penyusunan kebijakan]
    D --> D1["Pasal 65 ayat (6), Pasal 66, Pasal 91-93 UU 32/2009"]
    D --> D2[Hak menggugat di pengadilan]
    D --> D3[Perlindungan dari kriminalisasi]
```
...
```mermaid
flowchart TD
    A[MEKANISME GUGATAN LINGKUNGAN] --> B[Gugatan Perdata Biasa]
    A --> C[Gugatan Perwakilan Kelompok / Class Action]
    A --> D[Gugatan Warga Negara / Citizen Lawsuit]
    A --> E[Hak Gugat Organisasi LH / NGO Standing]
    A --> F[Gugatan Administratif ke PTUN]
    B --> B1["Pasal 87 UU 32/2009"]
    B --> B2[PMH atau strict liability]
    B --> B3[Ganti rugi individu]
    C --> C1["Pasal 91 UU 32/2009"]
    C --> C2[Perwakilan kelompok korban]
    C --> C3[Ganti rugi kolektif]
    D --> D1[Yurisprudensi]
    D --> D2[Setiap warga negara melawan pemerintah]
    D --> D3[Tujuan: kebijakan, bukan ganti rugi]
    E --> E1["Pasal 92 UU 32/2009"]
    E --> E2[LSM lingkungan sebagai penggugat]
    E --> E3[Tujuan: pelestarian fungsi LH]
    F --> F1[UU PTUN jo. UU 32/2009]
    F --> F2[Menggugat KTUN terkait lingkungan]
```
