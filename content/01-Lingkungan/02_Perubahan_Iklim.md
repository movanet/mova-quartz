...
```mermaid
graph LR
    A[Aktivitas Manusia] --> B[Emisi GRK]
    B --> C[Peningkatan Konsentrasi GRK di Atmosfer]
    C --> D[Efek Rumah Kaca Meningkat]
    D --> E[Pemanasan Global]
    E --> F[Perubahan Iklim]
    F --> G[Dampak Lingkungan]
    G --> G1[Kenaikan Muka Air Laut]
    G --> G2[Cuaca Ekstrem]
    G --> G3[Kerusakan Ekosistem]
    G --> G4[Ancaman Ketahanan Pangan]
    F --> H[Respons Hukum]
    H --> H1[Hukum Internasional]
    H --> H2[Hukum Nasional]
    H --> H3[Litigasi Iklim]
```
...
```mermaid
timeline
    title Evolusi Hukum Iklim Internasional
    1992 : UNFCCC diadopsi di Rio de Janeiro
         : Kerangka kerja dasar perubahan iklim
    1994 : UNFCCC mulai berlaku
         : Indonesia ratifikasi via UU 6/1994
    1997 : Protokol Kyoto diadopsi di Jepang
         : Target mengikat bagi negara maju
    2004 : Indonesia ratifikasi Protokol Kyoto
         : Via UU 17/2004
    ...
    2023 : Global Stocktake pertama selesai
         : COP28 Dubai
    2025 : ICJ Advisory Opinion on Climate
         : NDC Kedua Indonesia disampaikan
```
