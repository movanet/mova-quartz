...
```mermaid
graph TB
    A[Isu-Isu Kontemporer Hukum Lingkungan]
    
    A --> B[Perdagangan Karbon & NEK]
    A --> C[Polusi Plastik]
    A --> D[ESG & Green Finance]
    A --> E[Litigasi Iklim]
    A --> F[Rights of Nature]
    A --> G[Ekonomi Sirkular]
    A --> H[Teknologi Digital]
    A --> I[Transisi Energi]
    
    B --> B1["Perpres 110/2025"]
    B --> B2["Cap-and-Trade"]
    B --> B3["Carbon Tax"]
    B --> B4["REDD+ & Results Payment"]
    
    C --> C1["EPR Mandatory 2025"]
    C --> C2["Negosiasi Perjanjian Plastik Global"]
    C --> C3["Infrastruktur Daur Ulang"]
    
    D --> D1["POJK 51/2017"]
    D --> D2["Taksonomi Hijau TKBI v2"]
    D --> D3["Green Bonds & Sukuk"]
    D --> D4["Disclosure ESG"]
    
    E --> E1["2,967 Kasus Global"]
    E --> E2["Litigasi vs Pemerintah"]
    E --> E3["Litigasi vs Korporasi"]
    E --> E4["Prospek di Indonesia"]
    
    F --> F1["Konstitusi Ekuador & Bolivia"]
    F --> F2["Hukum Adat Indonesia"]
    F --> F3["Sungai-Sungai Bergerak"]
    
    G --> G1["PP 27/2020"]
    G --> G2["Permen LHK 75/2019"]
    G --> G3["5R Framework"]
    
    H --> H1["Remote Sensing"]
    H --> H2["AI & Machine Learning"]
    H --> H3["IoT Monitoring"]
    H --> H4["Drone Technology"]
    
    I --> I1["JETP Partnership"]
    I --> I2["Perpres 112/2022"]
    I --> I3["Target 44% EBT 2030"]
```

```mermaid
graph LR
    A["Ekonomi Linear<br/>Take-Make-Dispose"]
    
    A --> B["Extraction"]
    B --> C["Production"]
    C --> D["Consumption"]
    D --> E["Waste to Landfill"]
    
    E -.-> F["Circular Economy<br/>Reduce-Reuse-Recycle"]
    
    F --> G["Design for Circularity"]
    G --> H["Production<br/>Efficiency"]
    H --> I["Consumer Use"]
    I --> J["Recovery &<br/>Recycling"]
    J --> G
    
    K["Material Value Retention"]
...
```mermaid
graph TB
    JETP["Just Energy Transition Partnership Indonesia"]
    
    JETP --> Target["2030 Targets"]
    JETP --> Finance["Financing"]
    JETP --> Support["Support Programs"]
    JETP --> Challenges["Challenges"]
    
    Target --> T1["250 MtCO2 Emission Cap"]
    Target --> T2["44% Renewable Energy"]
    Target --> T3["2050 Net-Zero Grid"]
    
    Finance --> F1["USD 20 Billion Total"]
    Finance --> F2["Public + Private Funding"]
    Finance --> F3["Green Bonds & IFI Loans"]
    
    Support --> S1["Worker Retraining"]
    Support --> S2["Community Development"]
    Support --> S3["Technology Transfer"]
    Support --> S4["Grid Modernization"]
    
    Challenges --> Ch1["Coal Industry Resistance"]
    Challenges --> Ch2["Grid Integration Issues"]
    Challenges --> Ch3["Battery Storage Cost"]
    Challenges --> Ch4["Just Transition Implementation"]
    
    style JETP fill:#ff9999
    style T1 fill:#99ff99
    style T2 fill:#99ff99
    style T3 fill:#99ff99
    style Ch4 fill:#ffcccc
```
